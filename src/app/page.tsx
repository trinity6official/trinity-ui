    ...
    <main className="shell">
      ...
      <section className="hero" aria-labelledby="hero-title">
        <div className="heroInner">
          ...
          <p className="intro">
            Trinity6 is becoming an interactive environment for understanding technology and turning
            ideas into real work. The first world is a company you can explore, question, and learn
            from.
          </p>
          <IntentPrompt />
          <div className="pillRow" aria-label="Example goals">
            <span className="pill">Learn cybersecurity</span>
            <span className="pill">Understand AI</span>
            <span className="pill">Explore cloud</span>
            <span className="pill">Start an AI business</span>
          </div>
